...
function generateSoul(agentName: string, data: ConversationData): string {
...
function generateIdentity(agentName: string, data: ConversationData): string {
...
function generateStyle(data: ConversationData): string {
...
function generateUserCore(data: ConversationData): string {
